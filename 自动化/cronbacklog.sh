...
#echo $File
cd $HOME
tar -czf $File.tar.gz ./qtrade/flow/* ./qtrade/dump/* ./qtrade/bin/Syslog.log ./qmdb/flow/* ./qmdb/bin/Syslog.log ./qoffer1/flow/* ./qoffer1/bin/Syslog.log ./qdata/flow/* ./qdata/bin/Syslog.log
