...
source /home/risk/.bash_profile

date "+%Y%m%d %H:%M:%S" >> /home/risk/riskStorm/shell/run.log
echo $0 $1 >> /home/risk/riskStorm/shell/run.log
...
for i in "$APP_HOME"/lib/pricingcalculator/*.*; do
CLASSPATH="$CLASSPATH":"$i"
done
