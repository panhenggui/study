myapp.controller('capitalRiskParamController', function ($scope, $timeout) {
    ...
    queryInstClientID(function (result) {
        ...
        $scope.subCapitalAccountTradingLimitService.findCapRiskParamByCondition(function(result){
 ...
 // 重置表单验证信息
    ...
    $scope.save = function (entity) {
        ...
        //增加
        if (index == undefined) {
        	$scope.subCapitalAccountTradingLimitService.addCapBwEntitys(function(results){
	    	...
	    	$scope.subCapitalAccountTradingLimitService.updateCapBwEntitys(function(results){
	    		if(results != null && results.length > 0){
