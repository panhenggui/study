//期货保证金设置
myapp.controller('FuturesProductMarginSetController', function ($scope, $timeout) {
    //初始化页面信息
    ...
    $scope.initParameter = function () {
        ...
        $scope.ModalEntity.lockMarginRate=0;
        //设置checkbox未选中
        ...
        if (index == undefined) {
            checkProduct(function (result) {
                if (result != undefined) {
                    ...
                    saveProductMarginSetEntity(function (result) {
            ...
            updateProductMarginSetEntity(function (result) {
    ...
    $scope.checkValue = function (value) {
        if (!value) {
            $scope.ModalEntity.lockMarginRate=0;
            $scope.ModalEntity.lockMarginAmt=eval("");
        }else{
            $scope.ModalEntity.lockMarginRate=oldRate==""?0:oldRate;
            $scope.ModalEntity.lockMarginAmt=oldAmt==""?0:oldAmt;
        }
    }
});
